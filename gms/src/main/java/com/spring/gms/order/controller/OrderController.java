package com.spring.gms.order.controller;
...
public class OrderController {
	...
	public ModelAndView orderGoods(@RequestParam("goodsCd") int goodsCd, HttpServletRequest request) throws Exception {
	...
	public ResponseEntity<Object> orderGoods(OrderDto orderDto, HttpServletRequest request) throws Exception {
		...
		String jsScript  = "<script>";
			   jsScript += " alert('주문을 완료했습니다');";
			   jsScript += " location.href='" + request.getContextPath() + "/myPage/myOrderList?goodsCd=" + orderDto.getGoodsCd() + "';";
			   jsScript += "</script>";
