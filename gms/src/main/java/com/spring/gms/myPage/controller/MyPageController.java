package com.spring.gms.myPage.controller;
...
import com.spring.gms.myPage.service.MyPageService;
import com.spring.gms.order.service.OrderService;
...
public class MyPageController {
	...
	public ResponseEntity<Object> removeOrder(HttpServletRequest request) throws Exception {
		 
		 orderService.removeOrder(Integer.parseInt(request.getParameter("orderCd")));
		 HttpHeaders responseHeaders = new HttpHeaders();
		 responseHeaders.add("Content-Type", "text/html; charset=utf-8");
		 
		 String jsScript  = "<script>";
		 	    jsScript += " alert('주문취소 되었습니다.');";
