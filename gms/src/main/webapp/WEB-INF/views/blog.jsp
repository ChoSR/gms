	...
	<section class="blog-section">
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
					<div class="blog-item">
						<img src="${contextPath }/resources/bootstrap/img/blog/1.jpg" alt="">
						<h2>5 Exercises for a six pack</h2>
						<div class="blog-metas">
							<div class="blog-meta"><img src="${contextPath }/resources/bootstrap/img/icons/edit.png" alt=""> By Admin</div>
							<div class="blog-meta"><img src="${contextPath }/resources/bootstrap/img/icons/layout.png" alt="">in Workout</div>
							<div class="blog-meta"><img src="${contextPath }/resources/bootstrap/img/icons/profile.png" alt="">2 comments</div>
						</div>
					...
					<div class="blog-item">
						<img src="${contextPath }/resources/bootstrap/img/blog/2.jpg" alt="">
					...
					<div class="blog-item">
						<img src="${contextPath }/resources/bootstrap/img/blog/3.jpg" alt="">
				...
				<div class="col-lg-4 col-md-7 col-sm-9 sidebar">
					<div class="widget-area">
						<form class="search-widget">
							...
							<button><img src="${contextPath }/resources/bootstrap/img/icons/search.png" alt=""></button>
						</form>
					</div>
					<div class="widget-area">
					...
					<div class="widget-area">
						...
						<div class="recent-post-widget">
							<div class="rp-item">
								<img src="${contextPath }/resources/bootstrap/img/blog/blog-widget/1.jpg" alt="">
								<div class="rp-text">
							...
							<div class="rp-item">
								<img src="${contextPath }/resources/bootstrap/img/blog/blog-widget/2.jpg" alt="">
								<div class="rp-text">
							...
							<div class="rp-item">
								<img src="${contextPath }/resources/bootstrap/img/blog/blog-widget/3.jpg" alt="">
								<div class="rp-text">
