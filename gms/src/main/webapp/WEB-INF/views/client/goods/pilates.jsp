	...
	<section class="trainers-section">
		<div class="container">
			<div class="section-title text-center">
				<h2>전문 <span>강사</span>들을 만나보세요</h2>
			</div>
			<div class="row">
				<div class="col-lg-3 col-sm-6">
					<div class="trainer-item">
						...
						<h4>Michael</h4>
						<p> 강사는 동국대학교 체육대학을 졸업하고 스포츠지도사 자격증 2급을 소유하고 있습니다.</p>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="trainer-item">
						...
						<h4>Jessica</h4>
						<p> 강사는 경희대학교 체육대학을 졸업하고 스포츠지도사 자격증 2급을 소유하고 있습니다.</p>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="trainer-item">
						...
						<h4>James</h4>
						<p> 강사는 한양대학교 체육대학을 졸업하고 스포츠지도사 자격증 2급을 소유하고 있습니다.</p>
					</div>
				</div>
				<div class="col-lg-3 col-sm-6">
					<div class="trainer-item">
