...
<body>
	...
	<section class="about-section">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4">
					<div class="about-img">
						<img src="${contextPath }/resources/bootstrap/img/about-img.png" alt="">
					</div>
				</div>
			</div>
	...
	<!-- Achievement section -->
	<div class="achievement-section set-bg" data-setbg="${contextPath }/resources/bootstrap/img/achievement-bg.jpg">
		<div class="container">
			<div class="row">
	...
	<!-- Certified section -->
	<section class="certified-section spad set-bg" data-setbg="${contextPath }/resources/bootstrap/img/certified-bg.jpg">
		<div class="container">
			<div class="row">
